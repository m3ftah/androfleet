...
# Master
if not os.path.exists(THIS + '/androfleet-master-1.0.zip'):
...
# Node
if not os.path.exists(THIS + '/androfleet-node-1.0.zip'):
...
# ServiceDiscovery
if not os.path.exists(THIS + '/androfleet-servicediscovery-1.0.zip'):
