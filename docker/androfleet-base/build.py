...
parser = argparse.ArgumentParser(prog='build.py', description='Docker androfleet-base container builder')
parser.add_argument('-p', '--push', action='store_true')
args = parser.parse_args()

subprocess.call(['docker', 'build', '-t', 'rsommerard/androfleet-base', '.'])
